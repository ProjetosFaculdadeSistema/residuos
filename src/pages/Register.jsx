        ...
        <div className="card-body">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-4">
            ...
            <div className="form-control">
              ...
              />
              {errors.senha && <label className="label"><span className="label-text-alt text-error">{errors.senha.message}</span></label>}
            </div>
            ...
            <div className="form-control">
              ...
              />
              {errors.confirmarSenha && <label className="label"><span className="label-text-alt text-error">{errors.confirmarSenha.message}</span></label>}
            </div>
          ...
          <p className="text-center text-sm">
            Já tem conta? <Link to="/login" className="link link-primary">Faça login</Link>
          </p>
        </div>
      </div>
    </div>
