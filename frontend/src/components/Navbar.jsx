...
function Navbar() {
  ...
  // pega apenas o usuario do Redux — evita re-renders desnecessários ao mudar outros campos do auth
  ...
  return (
    <div className="navbar bg-base-200 shadow-lg px-4">
      ...
      {/* menu principal — escondido em mobile, aparece a partir de md */}
        ...
        <div className="dropdown dropdown-end">
          <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar placeholder">
            <div className="bg-primary text-primary-content rounded-full w-10">
              {/* se tiver foto usa a imagem, senão mostra a inicial do nome */}
              {usuario?.foto ? (
